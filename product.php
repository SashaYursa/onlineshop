...
<div class="section main main-raised">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $sql = " SELECT products.*, categories.cat_title as category  FROM `products` LEFT JOIN `categories` ON `categories`.`cat_id` = `products`.`product_cat` where product_id = ${product_id}";
            if (!$con) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">' . $row['product_price'] . 'грн</h3>
								<span class="product-available">В наявності</span>
							</div>
							<p>' . $row['product_desc'] . '</p>
							<div class="add-to-cart">
								<button class="add-to-cart-btn" pid="' . $row['product_id'] . '"  id="product" ><i class="fa fa-shopping-cart"></i> Додати до кошику</button>
                                </div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 class="title">Подібні товари</h3>
