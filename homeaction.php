...
if (isset($_POST["categoryhome"])) {
  ...
  echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li class='mainItem active'><a href='index.php'>Головна</a></li>
	";
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price грн</h4>
									</div></a>
								</div>
...
if (isset($_POST['getPrices'])) {
  $sql = "SELECT MIN(products.product_price) as minPrice, MAX(products.product_price) as maxPrice  FROM `products`";
  $run_query = mysqli_query($con, $sql);

  echo json_encode(mysqli_fetch_array($run_query));
}
